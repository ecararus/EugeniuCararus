...
- Desktop application installed on the cash register in the point of sale;
- Web Strator application installed on a Strator server in an Altadis environment that will be available via
